package org.nervos.web3j.ens;

import org.nervos.web3j.crypto.WalletUtils;
import org.nervos.web3j.ens.contracts.generated.ENS;
import org.nervos.web3j.ens.contracts.generated.PublicResolver;
...
import org.nervos.web3j.protocol.core.methods.response.EthSyncing;
import org.nervos.web3j.protocol.core.methods.response.NetVersion;
import org.nervos.web3j.tx.ClientTransactionManager;
import org.nervos.web3j.tx.ManagedTransaction;
...
public class EnsResolver {
    ...
    String lookupAddress(String ensName) throws Exception {
        ...
        ENS ensRegistry = ENS.load(
                ...
                ManagedTransaction.GAS_PRICE, org.nervos.web3j.tx.Contract.GAS_LIMIT);
