package org.nervos.web3j.ens.contracts.generated;
...
import org.nervos.web3j.abi.EventEncoder;
import org.nervos.web3j.abi.EventValues;
import org.nervos.web3j.abi.FunctionEncoder;
...
import org.nervos.web3j.protocol.core.methods.request.EthFilter;
...
import org.nervos.web3j.tuples.generated.Tuple2;
import org.nervos.web3j.tx.Contract;
import org.nervos.web3j.tx.TransactionManager;

/**
 * <p>Auto generated code.
 * <p><strong>Do not modify!</strong>
 * <p>Please use the <a href="https://docs.web3j.io/command_line.html">web3j command line tools</a>,
 * or the org.nervos.web3j.codegen.SolidityFunctionWrapperGenerator in the
...
public final class PublicResolver extends Contract {
    ...
    public RemoteCall<Boolean> supportsInterface(byte[] interfaceID) {
        Function function = new Function("supportsInterface", 
                Arrays.<Type>asList(new org.nervos.web3j.abi.datatypes.generated.Bytes4(interfaceID)),
    ...
    public RemoteCall<TransactionReceipt> setText(byte[] node, String key, String value) {
        Function function = new Function(
                "setText", 
                Arrays.<Type>asList(new org.nervos.web3j.abi.datatypes.generated.Bytes32(node),
                new org.nervos.web3j.abi.datatypes.Utf8String(key),
                new org.nervos.web3j.abi.datatypes.Utf8String(value)),
    ...
    public RemoteCall<Tuple2<BigInteger, byte[]>> ABI(byte[] node, BigInteger contentTypes) {
        final Function function = new Function("ABI",
                Arrays.<Type>asList(new org.nervos.web3j.abi.datatypes.generated.Bytes32(node),
                new org.nervos.web3j.abi.datatypes.generated.Uint256(contentTypes)),
    ...
    public RemoteCall<TransactionReceipt> setPubkey(byte[] node, byte[] x, byte[] y) {
        Function function = new Function(
                "setPubkey",
                Arrays.<Type>asList(new org.nervos.web3j.abi.datatypes.generated.Bytes32(node),
                new org.nervos.web3j.abi.datatypes.generated.Bytes32(x),
                new org.nervos.web3j.abi.datatypes.generated.Bytes32(y)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setABI(byte[] node, BigInteger contentType, byte[] data) {
        Function function = new Function(
                "setABI",
                Arrays.<Type>asList(new org.nervos.web3j.abi.datatypes.generated.Bytes32(node),
                new org.nervos.web3j.abi.datatypes.generated.Uint256(contentType),
                new org.nervos.web3j.abi.datatypes.DynamicBytes(data)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setName(byte[] node, String name) {
        Function function = new Function(
                "setName",
                Arrays.<Type>asList(new org.nervos.web3j.abi.datatypes.generated.Bytes32(node),
                new org.nervos.web3j.abi.datatypes.Utf8String(name)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setContent(byte[] node, byte[] hash) {
        Function function = new Function(
                "setContent",
                Arrays.<Type>asList(new org.nervos.web3j.abi.datatypes.generated.Bytes32(node),
                new org.nervos.web3j.abi.datatypes.generated.Bytes32(hash)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setAddr(byte[] node, String addr) {
        Function function = new Function(
                "setAddr",
                Arrays.<Type>asList(new org.nervos.web3j.abi.datatypes.generated.Bytes32(node),
                new org.nervos.web3j.abi.datatypes.Address(addr)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<PublicResolver> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.nervos.web3j.abi.datatypes.Address(ensAddr)));
