...
public interface Ethereum {
    ...
    Request<?, org.nervos.web3j.protocol.core.methods.response.EthSendTransaction> ethSendTransaction(
            org.nervos.web3j.protocol.core.methods.request.Transaction transaction);

    Request<?, org.nervos.web3j.protocol.core.methods.response.EthSendTransaction> ethSendRawTransaction(
            String signedTransactionData);

    Request<?, org.nervos.web3j.protocol.core.methods.response.EthCall> ethCall(
            Call transaction,
            DefaultBlockParameter defaultBlockParameter);
    ...
    Request<?, EthFilter> ethNewFilter(org.nervos.web3j.protocol.core.methods.request.EthFilter ethFilter);
    ...
    Request<?, EthLog> ethGetLogs(org.nervos.web3j.protocol.core.methods.request.EthFilter ethFilter);
    ...
    Request<?, org.nervos.web3j.protocol.core.methods.response.ShhPost> shhPost(
            org.nervos.web3j.protocol.core.methods.request.ShhPost shhPost);
