package org.nervos.web3j.protocol.core.methods.request;
...
import org.nervos.web3j.crypto.ECKeyPair;
import org.nervos.web3j.crypto.Sign;
import org.nervos.web3j.protobuf.Blockchain;
...
import org.nervos.web3j.protobuf.ConvertStrByte;
import org.nervos.web3j.protobuf.Blockchain.Crypto;
...
public class Transaction {
    ...
    public String sign(String privateKey, boolean isEd25519AndBlake2b) {
        ...
        builder1.setCrypto(Blockchain.Crypto.SECP);
