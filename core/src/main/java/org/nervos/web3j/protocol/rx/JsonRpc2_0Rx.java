package org.nervos.web3j.protocol.rx;
...
import org.nervos.web3j.protocol.core.filters.BlockFilter;
import org.nervos.web3j.protocol.core.filters.Filter;
import org.nervos.web3j.protocol.core.filters.LogFilter;
import org.nervos.web3j.protocol.core.filters.PendingTransactionFilter;
...
import org.nervos.web3j.protocol.core.DefaultBlockParameterNumber;
import org.nervos.web3j.protocol.core.filters.BlockFilter;
import org.nervos.web3j.protocol.core.filters.LogFilter;
import org.nervos.web3j.protocol.core.filters.PendingTransactionFilter;
...
import org.nervos.web3j.protocol.core.methods.response.Transaction;
import org.nervos.web3j.utils.Observables;
...
public class JsonRpc2_0Rx {
    ...
    public Observable<Log> ethLogObservable(
            org.nervos.web3j.protocol.core.methods.request.EthFilter ethFilter, long pollingInterval) {
