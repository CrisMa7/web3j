package org.nervos.web3j.protocol.account;

import org.nervos.web3j.abi.*;
import org.nervos.web3j.abi.datatypes.Function;
import org.nervos.web3j.abi.datatypes.Type;
import org.nervos.web3j.abi.datatypes.UnorderedEvent;
...
import org.nervos.web3j.protocol.core.methods.response.*;
import org.nervos.web3j.tx.CitaTransactionManager;
import org.nervos.web3j.utils.TypedAbi;
...
public class Account {
    ...
    public EthSendTransaction deploy(File contractFile, BigInteger nonce, BigInteger quota, int version, int chainId, long value)
    ...
    public Future<EthSendTransaction> deployAsync(File contractFile, BigInteger nonce, BigInteger quota, BigInteger version, int chainId, long value)
            throws IOException, InterruptedException, CompiledContract.ContractCompileError {
        CompiledContract contract = new CompiledContract(contractFile);
        String contractBin = contract.getBin();
        return this.transactionManager.
    ...
    public Object callContract(String contractAddress, String funcName, BigInteger nonce, BigInteger quota, int version,
                               int chainId, long value, Object... args)
            throws Exception {
        if (abi == null) {
    ...
    public Object callContract(String contractAddress, AbiDefinition functionAbi, BigInteger nonce, BigInteger quota,
                               int version,int chainId, long value, Object... args)
            throws Exception {
    ...
    public Object sendTransaction(String contractAddress, Function func, BigInteger nonce, long quota, long version, int chainId, long value)
            throws IOException {
        String data = FunctionEncoder.encode(func);
    ...
    public Object uploadAbi(String contractAddress, String abi, BigInteger nonce, BigInteger quota, long version, int chainId, long value) throws Exception {
