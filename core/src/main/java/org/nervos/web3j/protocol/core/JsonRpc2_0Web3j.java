package org.nervos.web3j.protocol.core;
...
import org.nervos.web3j.protocol.core.methods.response.EthGetAbi;
import org.nervos.web3j.protocol.core.methods.response.EthMetaData;
import org.nervos.web3j.protocol.rx.JsonRpc2_0Rx;
...
import org.nervos.web3j.protocol.Web3j;
import org.nervos.web3j.protocol.Web3jService;
import org.nervos.web3j.protocol.core.methods.request.ShhFilter;
import org.nervos.web3j.protocol.core.methods.request.ShhPost;
...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    @Override
    public Request<?, org.nervos.web3j.protocol.core.methods.response.EthSendTransaction>
            ethSendTransaction(
        ...
        return new Request<>(
                ...
                web3jService,
                org.nervos.web3j.protocol.core.methods.response.EthSendTransaction.class);
    }
    ...
    @Override
    public Request<?, org.nervos.web3j.protocol.core.methods.response.EthCall> ethCall(
            Call call, DefaultBlockParameter defaultBlockParameter) {
        return new Request<>(
                "eth_call",
                Arrays.asList(call, defaultBlockParameter),
                web3jService,
                org.nervos.web3j.protocol.core.methods.response.EthCall.class);
    }
    ...
    public Request<?, EthFilter> ethNewFilter(
            org.nervos.web3j.protocol.core.methods.request.EthFilter ethFilter) {
        return new Request<>(
                "eth_newFilter",
    ...
    @Override
    public Request<?, org.nervos.web3j.protocol.core.methods.response.ShhPost> shhPost(ShhPost shhPost) {
        return new Request<>(
                "shh_post",
                Arrays.asList(shhPost),
                web3jService,
                org.nervos.web3j.protocol.core.methods.response.ShhPost.class);
    }
    ...
    @Override
    public Observable<org.nervos.web3j.protocol.core.methods.response.Transaction>
