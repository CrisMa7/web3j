...
import org.nervos.web3j.abi.FunctionReturnDecoder;
...
import org.nervos.web3j.tx.exceptions.ContractCallException;
...
public abstract class Contract extends ManagedTransaction {
    ...
    private List<Type> executeCall(
        ...
        org.nervos.web3j.protocol.core.methods.response.EthCall ethCall = web3j.ethCall(
