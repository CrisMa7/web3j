...
import org.nervos.web3j.ens.EnsResolver;
import org.nervos.web3j.ens.EnsResolver;
import org.nervos.web3j.protocol.Web3j;
import org.nervos.web3j.protocol.core.methods.response.EthGasPrice;
...
public abstract class ManagedTransaction {
    ...
    protected TransactionReceipt sendAdaptToCita(
            String to, String data, BigInteger quota, BigInteger nonce, BigInteger validUntilBlock, BigInteger version , int chainId, long value)
            throws IOException, TransactionException {
