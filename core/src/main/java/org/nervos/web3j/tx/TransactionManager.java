...
import org.nervos.web3j.tx.response.PollingTransactionReceiptProcessor;
import org.nervos.web3j.tx.response.TransactionReceiptProcessor;

import static org.nervos.web3j.protocol.core.JsonRpc2_0Web3j.DEFAULT_BLOCK_TIME;
...
public abstract class TransactionManager {
    ...
    protected TransactionReceipt executeTransaction(
            ...
            BigInteger nonce, BigInteger validUntilBlock, BigInteger version , int chainId, long value)
            throws IOException, TransactionException {
        EthSendTransaction ethSendTransaction = sendTransaction(
