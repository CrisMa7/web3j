...
import static org.nervos.web3j.crypto.ContractUtils.generateContractAddress;
...
public class ContractUtilsTest {
    ...
    public void testCreateContractAddress() {
        ...
        assertThat(ContractUtils.generateContractAddress(address, BigInteger.valueOf(209)),
                is("0xe41e694d8fa4337b7bffc7483d3609ae1ea068d5"));

        assertThat(ContractUtils.generateContractAddress(address, BigInteger.valueOf(257)),
