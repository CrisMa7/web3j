...
import org.nervos.web3j.abi.datatypes.generated.AbiTypes;
...
import org.nervos.web3j.utils.Collection;
import org.nervos.web3j.utils.Strings;
import org.nervos.web3j.utils.Version;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    private void addAddressesSupport(TypeSpec.Builder classBuilder, Map<String, String> addresses) {
        if (addresses != null) {
            ...
            // See org.nervos.web3j.tx.Contract#getStaticDeployedAddress(String)
        ...
        if (parameterSpec.type instanceof ParameterizedTypeName) {
            ...
            if (typeNames.size() != 1) {
                ...
                return "new " + parameterSpec.type + "(\n"
                        + "        org.nervos.web3j.abi.Utils.typeMap("
    ...
    private void buildConstantFunction(
        ...
        if (outputParameterTypes.isEmpty()) {
            ...
            ParameterizedTypeName parameterizedTupleType = ParameterizedTypeName.get(
                    ClassName.get(
                            "org.nervos.web3j.tuples.generated",
    ...
    private static Class<?> getStaticArrayTypeReferenceClass(String[] splitType) {
        try {
            return Class.forName("org.nervos.web3j.abi.datatypes.generated.StaticArray" + splitType[1]);
