...
import static org.nervos.web3j.codegen.SolidityFunctionWrapperGenerator.JAVA_TYPES_ARG;
import static org.nervos.web3j.codegen.SolidityFunctionWrapperGenerator.SOLIDITY_TYPES_ARG;
import static org.nervos.web3j.codegen.SolidityFunctionWrapperGenerator.getFileNameNoExtension;
...
public class SolidityFunctionWrapperGeneratorTest extends TempFileProvider {
    ...
    private void testCodeGenerationJvmTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, "org.nervos.web3j.unittests.java", JAVA_TYPES_ARG);
    ...
    private void testCodeGenerationSolidityTypes(
        ...
        testCodeGeneration(
                contractName, inputFileName, "org.nervos.web3j.unittests.solidity", SOLIDITY_TYPES_ARG);
    }
