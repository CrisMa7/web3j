...
import static org.nervos.web3j.codegen.FunctionWrapperGenerator.JAVA_TYPES_ARG;
import static org.nervos.web3j.codegen.FunctionWrapperGenerator.SOLIDITY_TYPES_ARG;

public class TruffleJsonFunctionWrapperGeneratorTest extends TempFileProvider {

    private static final String PackageName = "org.nervos.web3j.unittests.truffle.java";
