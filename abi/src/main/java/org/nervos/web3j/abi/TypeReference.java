 ...
 * This is so that we can pass around Typed {@link org.nervos.web3j.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends org.nervos.web3j.abi.datatypes.Type>
    ...
    public static <T extends org.nervos.web3j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public static <T extends org.nervos.web3j.abi.datatypes.Type> TypeReference<T> create(
    ...
    public static <T extends org.nervos.web3j.abi.datatypes.Type> StaticArrayTypeReference<T> create(
    ...
    public abstract static class StaticArrayTypeReference<T extends org.nervos.web3j.abi.datatypes.Type>
