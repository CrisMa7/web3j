...
.. code-block:: xml
   ...
   <dependency>
     <groupId>org.nervos.web3j</groupId>
...
.. code-block:: groovy
   ...
   compile ('org.nervos.web3j:core:3.2.0')

Android:

.. code-block:: groovy

   compile ('org.nervos.web3j:core:3.1.1-android')
...
you can use the *org.nervos.web3j:parity* and *org.nervos.web3j:geth* modules respectively.
